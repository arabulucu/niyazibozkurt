    ...
    state = {
        services: [
            ...
            },
            {
                ...
                contentImage: "./img/niyazi1.jpg",
                content: `Stajyer avukat olarak ilgi alanıma giren hukuk türleri:`,
                contentList: `              
                •	Enerji Hukuku,
                • Spor Hukuku
                •	Bilişim Hukuku,
...
`,
            },
            {
                ...
                Tahkim ve hak talebi kapsamında verdiğim başlıca uzmanlıklarım şu şekildedir: `,
            ...
            <section className="page-section aboutSection mt-5" id="services" style={{ backgroundColor: "#fff" }}>
                <div className="container">
                    <div className="row text-center">
                        ...
                        Yapay Zeka ve Proje Yönetimi<br />ile <br /> Yeni Nesil Hukuk</h3>
